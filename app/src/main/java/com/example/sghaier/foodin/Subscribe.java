...
public class Subscribe extends AppCompatActivity {
    ...
    EditText edit_email,edit_nom,edit_prenom,passwd,confirm_passwd,adresse_complement,phone,datenaissance;
    AutoCompleteTextView adresse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adresse = (AutoCompleteTextView) this.findViewById(R.id.edit_adresse_subscribe);
        ...
        // TODO read adresse and setting with autocomplete google maps
        //adresse
