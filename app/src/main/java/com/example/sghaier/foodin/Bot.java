...
public class Bot extends Fragment {
    ...
    LinearLayout linearreponse2, linearresultrecherche;
    RelativeLayout layoutquestion2,linearreponse1;
...
//        listbot.setAdapter(adapter);
        ...
        linearreponse1 = (RelativeLayout) rootView.findViewById(R.id.linearreponse1);
